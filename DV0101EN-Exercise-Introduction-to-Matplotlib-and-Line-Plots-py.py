...
df_can['Total'] = df_can.sum(axis=1) #interesting
df_can.head()
...
df_Ind_Chn = df_can.loc[['India','China'], years] # passing in years 1980 - 2013 to exclude the 'total' column
df_Ind_Chn.head()
...
df_Ind_Chn = df_Ind_Chn.transpose()
df_Ind_Chn.head()
...
### type your answer here
df_Ind_Chn.index = df_Ind_Chn.index.map(int) # let's change the index values of df_Ind_Chn to type integer for plotting
df_Ind_Chn.plot(kind='line')
